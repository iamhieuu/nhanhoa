...
- [13. Những lưu ý "chết người" – Dễ mất file/data](#13-những-lưu-ý-chết-người--dễ-mất-filedata)
- [14. Cấu hình nâng cao qua SSH (cho Admin)](#14-cấu-hình-nâng-cao-qua-ssh-cho-admin)
  - [14.1 Check log hệ thống & đăng nhập SSH](#141-check-log-hệ-thống--đăng-nhập-ssh)
  - [14.2 Check log tài khoản user cụ thể](#142-check-log-tài-khoản-user-cụ-thể)
  - [14.3 Check log Mail (Postfix/Qmail)](#143-check-log-mail-postfixqmail)
  - [14.4 Check log Web (Nginx/Apache)](#144-check-log-web-nginxapache)
  - [14.5 Check log Plesk Panel](#145-check-log-plesk-panel)
